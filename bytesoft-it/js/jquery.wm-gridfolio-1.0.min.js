    ...
    e.fn.extend({
        WMGridfolio: function (n) {
            var i = {
                ...
                thumbnail: {columns: 6, minSize: 100, margin: 5},
                details: {minHeight: 400, speed: 350, full_w: !1},
                config: {open: "open", openToTop: !0, hasImg: !0, keepOpen: !1, onlyThumb: !1},
                callbacks: {CB_LoadGrid: !1, CB_ResizeGrid: !1, CB_OpenDetail: !1, CB_CloseDetail: !1, CB_CloseAll: !1}
            }, n = e.extend(!0, i, n), t = {
                container: !1,
                element: !1,
                thumbnail: !1,
                ...
                getWidthColumn: function (e) {
                    ...
                    return a
                }, openContent: function (i) {
                    var s = i, a = s.parent(), o = n.selectors.details, l = n.selectors.arrow, c = n.config.open, r = n.details.speed, d = e("." + o).find("> div").height(), m = n.selectors.close, p = d + (30 - 2 * n.thumbnail.margin);
                    if (s.addClass(c), s.parent().addClass(c), n.config.keepOpen === !0 ? (a.css({"margin-bottom": p + "px"}).addClass("wm-margin"), a.find("." + o).css({height: p + "px"}).addClass(c), t.CB_OpenDetail()) : (a.animate({"margin-bottom": p + "px"}, r).addClass("wm-margin"), a.find("." + o).stop().animate({height: p + "px"}, r, function () {
                            t.CB_OpenDetail()
                        }).addClass(c), a.find("." + l).show()), n.config.openToTop && a.offset()) {
                        var f = a.offset().top;
                        e("html, body").animate({scrollTop: f}, "500")
                    }
                    t.container = a.parent(), t.element = a, t.thumbnail = s, t.details = a.find("." + o), t.close = a.find("." + m)
                }, closeContent: function (i, a) {
                    var o = i, l = a, c = n.selectors.details, r = n.selectors.thumbnail, d = n.selectors.item, m = n.selectors.arrow, p = n.selectors.close, f = n.config.open, h = n.details.speed;
                    if (o.find("." + r).removeClass(f), o.find("." + d).removeClass(f), n.config.keepOpen === !0) {
                        var C = o.find(".wm-margin"), u = o.find("." + f);
                        C.removeClass("wm-margin"), u.removeClass(f), l && s.openContent(l), C.css({"margin-bottom": "0px"}), u.css({height: "0px"}), t.CB_CloseDetail()
                    } else o.find(".wm-margin").animate({"margin-bottom": "0px"}, h + 50).removeClass("wm-margin"), o.find("." + c + "." + f).stop().animate({height: "0px"}, h, function () {
                ...
                dynamicCSS: function (i, t, a, o) {
                    var l = i, c = t, r = a, d = o, m = n.selectors.details, p = s.getWidthColumn(l), f = n.config.open, h = n.thumbnail.margin, C = r.width() / 2 - 2 * h, u = e("." + m).find("> div").height(), g = u + (30 - 2 * h);
                    e("." + m).hasClass(f) && (e("." + n.selectors.item + "." + f).css({"margin-bottom": g + "px"}), e("." + m + "." + f).css({height: g + "px"})), c.css({
                        width: p + "px",
                        height: p + "px"
                    }), d.css({left: C + "px"}), n.config.hasImg && (r.css({"line-height": Math.floor(p - 2 * h - 1) + "px"}), r.find("img").css({
                    ...
                    i.on("click", function () {
                        var i = e(this), a = i.parent().parent().parent(), o = n.config.open;
                        s.closeContent(a, !1), a.removeClass(o), t.CB_CloseAll()
                    })
                }, staticCSS: function (e, i, t, s, a) {
                    var o = i, l = s, c = n.thumbnail.margin;
                    l.css({height: "0px"}), l.find("> div").css({"min-height": n.details.minHeight}), n.details.full_w || l.find("> div").css({
                        "margin-left": c,
                        "margin-right": c
                    }), o.css({padding: c + "px"})
                }
            ...
            return this.each(function () {
                var i = e(this), s = i.find("." + n.selectors.item), o = i.find("." + n.selectors.thumbnail), l = i.find("." + n.selectors.details), c = i.find("." + n.selectors.close), r = i.find("." + n.selectors.arrow);
